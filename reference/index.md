...
Download and manage model data
...
- [`list_sky_data()`](https://tylermorganwall.github.io/skymodelr/reference/list_sky_data.md)
  : List cached sky data files
- [`clear_sky_data()`](https://tylermorganwall.github.io/skymodelr/reference/clear_sky_data.md)
  : Clear cached sky data files

## Model Metadata

Prepare location, time, and model settings for native Prague sky queries
