# ---------------------------------------------------------------------------
# Helpers to convert POSIXct to Julian Date (UTC noon 1 Jan 2000 = 2451545).
...
#' @param resolution Default `2048`. Map half-width; the output image is `2 * resolution` by `resolution`.
