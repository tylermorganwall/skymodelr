...
makesky_rcpp <- function(albedo = 0.5, turbidity = 3.0, elevation = 10.0, azimuth_deg = 90, resolution = 2048L, numbercores = 1L, model = "hosek", prg_dataset = "", altitude = 0.0, visibility = 50.0, render_solar_disk = TRUE, lambda_nm = NULL) {
    .Call(`_skymodelr_makesky_rcpp`, albedo, turbidity, elevation, azimuth_deg, resolution, numbercores, model, prg_dataset, altitude, visibility, render_solar_disk, lambda_nm)
}
