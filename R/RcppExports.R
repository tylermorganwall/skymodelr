...
make_starfield_rcpp <- function(outfile, stars, resolution = 2048L, zero_point = 1.0, lon_deg = 0.0, lat_deg = 0.0, jd = 2451545.0, use_rgb = TRUE, ncores = 1L) {
    invisible(.Call(`_skymodelr_make_starfield_rcpp`, outfile, stars, resolution, zero_point, lon_deg, lat_deg, jd, use_rgb, ncores))
}
